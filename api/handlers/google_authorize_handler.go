...
func NewGoogleLoginHandler() Handler {
...
func (g googleAuthorizeHandler) Handler(writer http.ResponseWriter, request *http.Request) {
	...
	authURL := fmt.Sprintf("%s?client_id=%s&redirect_uri=%s&response_type=code&scope=%s&state=%s",
		googleauth.GoogleAuthURL, googleauth.GoogleClientID, url.QueryEscape(googleauth.GoogleRedirectURL), googleauth.Scopes, encodedParams)
